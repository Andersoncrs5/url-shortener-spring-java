package com.write.api.adapters.out.messaging.dlq.urlAccessRule;

import com.fasterxml.jackson.core.type.TypeReference;
import com.write.api.application.dto.messaging.OutboxEventMessage;
import com.write.api.application.dto.outbox.events.urlAccessRule.UrlAccessRuleDeletedEvent;
...
public class UrlAccessRuleDeletedDlqConsumer {

    private final HandlerDlqUseCase handlerDlq;

    @KafkaListener(
            topics = "url.access.rule.created.dlq",
    ...
    public void consume(String payload) {
        ...
        Result<Void> result = handlerDlq.execute(
                payload,
                new TypeReference<OutboxEventMessage<UrlAccessRuleDeletedEvent>>() {}
        );

package com.write.api.adapters.out.messaging.dlq.another;
...
public class NotifyAdminsDlqConsumer {

    private final HandlerDlqUseCase handlerDlq;

    @KafkaListener(
            topics = "notify.admins.dlq",
    ...
    public void consume(String payload) {
        ...
        Result<Void> result = handlerDlq.execute(
                payload,
                new TypeReference<OutboxEventMessage<NotifyAdmEvent>>() {}
        );

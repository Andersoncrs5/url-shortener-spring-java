package com.write.api.adapters.out.messaging.dlq.apiKey;
...
public class ApiKeyCreatedDlqConsumer {
    HandlerDlqUseCase handlerDlq;

    @KafkaListener(
            topics = "api.key.created.dlq",
    ...
    public void consume(String payload) {
        ...
        Result<Void> result = handlerDlq.execute(
                payload,
                new TypeReference<OutboxEventMessage<ApiKeyCreatedEvent>>() {}
        );

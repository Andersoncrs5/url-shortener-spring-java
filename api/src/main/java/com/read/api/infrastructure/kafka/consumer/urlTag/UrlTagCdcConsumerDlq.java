...
@Slf4j
@Component
public class UrlTagCdcConsumerDlq
        extends AbstractDlqConsumer<UrlTagCdcEvent> {

    public UrlTagCdcConsumerDlq(
    ...
    private static final TypeReference<DeadLetterEvent<UrlTagCdcEvent>> TYPE =
            new TypeReference<>() {};

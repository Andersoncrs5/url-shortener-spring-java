...
class InsertRoleUseCaseImplTest extends BaseUseCaseTest {

    @Mock
    private RoleRepository repository;

    @InjectMocks
    private InsertRoleUseCaseImpl useCase;

    @Test
    void should_insert_role_successfully() {
